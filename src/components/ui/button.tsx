...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const variants = {
      primary: 'bg-[#1d9e75] text-white hover:bg-[#0f6e56] focus:ring-[#1d9e75]',
      secondary: 'bg-gray-100 text-gray-900 hover:bg-gray-200 focus:ring-gray-300',
      outline: 'border-2 border-[#1d9e75] text-[#1d9e75] hover:bg-[#1d9e75] hover:text-white focus:ring-[#1d9e75]',
